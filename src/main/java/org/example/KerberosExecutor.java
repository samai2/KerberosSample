...
public class KerberosExecutor {
    ...
    private static void propertiesSetup() throws FileNotFoundException {
        ...
        System.setProperty("java.security.auth.login.config", PATH_TO_JAAS_CONFIG);
    }
